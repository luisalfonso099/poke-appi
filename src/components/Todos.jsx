                    ...
                    pokemons.map(poke => {
                        return (
                            <div key={poke.id} className="card bg-light shadow-sm m-2 p-2 d-flex align-items-center justify-content-center" style={{"width": "350px"}}>
                                <img src={`https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/official-artwork/${poke.id}.png`} style={{height:"350px"}} className="card-img-top" alt={poke.name}/>
                                <div className="card-body">
                                  <h5 className="fs-3 card-title fst-italic">{poke.name}  #{poke.id}</h5>
